...
import { ConfirmarExclusaoEmpresaProps } from "../../types";



const ConfirmarExclusaoEmpresa: React.FC<ConfirmarExclusaoEmpresaProps> = ({ empresa, onClose, onConfirm }) => {
    return (
...
export default ConfirmarExclusaoEmpresa;
