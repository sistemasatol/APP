...
interface DeleteEnterpriseConfirmProps {
    enterprise: Enterprise;
    onClose: () => void;
    onConfirm: () => void;
}

const DeleteEnterpriseConfirm: React.FC<DeleteEnterpriseConfirmProps> = ({ enterprise, onClose, onConfirm }) => {
    return (
...
export default DeleteEnterpriseConfirm;
